$(function(){
	$('.still').click(function(){
		if($('.line-none').height()==""){
			$('.line-none').css({"height":"auto","overflow":"visible"})
		}else{
			$('.line-none').css({"height":"0","overflow":"hidden"})
		}
		})
	$('.still2').click(function(){
		console.log('1')
		if($('.line-none2').height()==""){
			$('.line-none2').css({"height":"auto","overflow":"visible"})
		}else{
			$('.line-none2').css({"height":"0","overflow":"hidden"})
		}
	})
